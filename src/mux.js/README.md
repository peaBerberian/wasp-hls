...
fMP4's are structured in _boxes_ as described in the ISOBMFF spec.
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      segments = ["segment-0.ts", "segment-1.ts", "segment-2.ts"];
...
_NOTE: This player is only for example and should not be used in production._
